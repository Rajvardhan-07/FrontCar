...
@Component({
  selector: 'app-scheduled-wash-customer',
  templateUrl: './scheduled-wash-customer.component.html',
  styleUrls: ['./scheduled-wash-customer.component.css']
})
export class ScheduledWashCustomerComponent {
